...
// instantiate the class
    ...
    $mailer->Subject = $POST["subjectfield"];
...
//for file attachments
    ...
    $uploaddir = 'uploads/';
    $uploadfile = $uploaddir . basename($FILES['fileattach']['name']);
    move_uploaded_file($FILES['fileattach']['tmp_name'], $uploadfile);
    $firstfile = $POST["fileattach"];
